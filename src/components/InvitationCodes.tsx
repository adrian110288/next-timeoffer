        ...
        <div className="space-y-8 mt-12">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500">
                        Generate and manage invitation codes for your new
                        employees.
                    </p>
                </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Share these codes with your employees to join your
                        company
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <ol className="list-decimal pl-5 space-y-2">
                        <li>
                            Generate a new invitation code using the button
                            above
                        </li>
                        <li>Share the 6-digit code with your employee</li>
                        <li>
                            The employee will sign up and enter this code during
                            onboarding
                        </li>
                        <li>
                            Once used, the code will be marked as
