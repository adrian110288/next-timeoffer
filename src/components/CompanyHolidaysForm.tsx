...
const CompanyHolidaysForm = ({
    ...
    const [selectedHoliday, setSelectedHoliday] =
        useState<CompanyHoliday | null>(null);
            ...
            setHolidays(
                holidays.map((h) =>
                    h.id === selectedHoliday.id
                        ? {
                              ...updatedHoliday,
                              date: new Date(updatedHoliday.date),
                          }
                        : h
                )
            );
                    ...
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                ...
                                Recurring holidays will be observed every year.
                            </DialogDescription>
                        </DialogHeader>
                        <Form {...addForm}>
                            <form
            ...
            <Card>
                ...
                <CardContent>
                    <ul className="list-disc pl-5 space-y-2">
                        <li>
                            <strong>
                                Company holidays are excluded from time off
                                calculations
                            </strong>{" "}
                            - When employees request time off that includes
                            company holidays, these days won&lsquo;t count
                            against their leave balance.
                        </li>
                        <li>
                            <strong>Recurring holidays</strong> - Holidays
                            marked as recurring will automatically be observed
                            on the same month and day each year.
                        </li>
                        <li>
                            <strong>Holiday visibility</strong> - All employees
                            will see company holidays when requesting time off.
                        </li>
                        <li>
                            <strong>Holiday management</strong> - Only
                            administrators can add, edit, or delete company
                            holidays.
                        </li>
                    </ul>
                </CardContent>
